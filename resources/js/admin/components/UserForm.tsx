...
export const UserForm: React.FC<UserFormProps> = ({ user, onChange }) => {
  return (
    <div className="p-4 rounded space-y-4">
      <div>
        <label className="block text-sm font-medium text-[#94a1b2]">Nome</label>
        <input
          type="text"
          value={user.name}
      ...
      <div>
        <label className="block text-sm font-medium text-[#94a1b2]">Email</label>
        <input
          type="email"
          value={user.email}
      ...
      <div>
        <label className="block text-sm font-medium text-[#94a1b2]">Senha</label>
        <input
          type="password"
          value={user.password || ''}
      ...
      <div>
        <label className="block text-sm font-medium text-[#94a1b2]">Função</label>
        <select
          value={user.role}
